"""
DINO fine-tune config — DINO fine-tune — OVERSAMPLED (class-balanced, oversample_thr=0.17).
Uses ClassBalancedDataset with oversample_thr=0.17 instead of 0.1, so that
...
Train with:
  ...
  python ~/LCFusion_LT3D/train_dino.py \
    ~/LCFusion_LT3D/configs/dino_nuscenes_oversampled.py
"""

_base_ = ['./dino_nuscenes_unbalanced.py']
...
work_dir = '/home/batashey/mmdetection3d/work_dirs/dino_nuscenes_oversampled'
